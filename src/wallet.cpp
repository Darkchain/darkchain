...
// DarkChain: total coins staked (non-spendable until maturity)
...
// DarkChain: check 'spent' consistency between wallet and txindex
// DarkChain: fix wallet spent state according to txindex
...
// DarkChain: disable transaction (only for coinstake)
